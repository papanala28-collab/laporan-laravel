<section>
    <h3 class="text-sm font-semibold uppercase tracking-[0.25em] text-slate-500">{{ $title }}</h3>
            ...
            <table class="min-w-full table-fixed divide-y divide-slate-200 text-sm">
                ...
                <thead class="bg-slate-50 text-slate-500">
                    <tr>
                        ...
                        <th class="px-3 py-3 text-left text-[11px] font-semibold uppercase tracking-[0.16em] sm:px-4">{{ $title }}</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-100">
                    @foreach ($lines as $index => $line)
                        <tr>
                            ...
                            <td class="px-3 py-3 text-sm text-slate-700 sm:px-4">{{ $line }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
